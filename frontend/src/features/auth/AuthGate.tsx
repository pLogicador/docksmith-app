      ...
      <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-bg px-6 text-center text-text-primary">
        ...
        <div className="max-w-sm space-y-2">
          <h1 className="font-display text-lg font-semibold">
            {status === "expired" ? "Sessão expirada" : "Faça login pelo Syncron"}
          </h1>
          <p className="text-sm text-text-secondary">
            {status === "expired"
              ? "Seu acesso expirou. Volte ao Syncron e abra o Docksmith novamente."
              : "O Docksmith é acessado através do Syncron. Entre na sua conta e abra o Docksmith por lá."}
          </p>
        </div>
        <a
          href={HUB_URL}
