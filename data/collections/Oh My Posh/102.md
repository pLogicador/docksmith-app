...
*   toml
    ...
    {  "type": "ytm",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#FF0000",  "properties": {    "playing_icon": " ",    "paused_icon": " ",    "stopped_icon": " "  },  "cache": {    "duration": "5s",    "strategy": "session"  }}

    type: ytmstyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#FF0000"properties:  playing_icon: " "  paused_icon: " "  stopped_icon: " "cache:  duration: 5s  strategy: session

    type = "ytm"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#FF0000"[cache]duration = "5s"strategy = "session"[blocks.segments.properties]playing_icon = " "paused_icon = " "stopped_icon = " "
