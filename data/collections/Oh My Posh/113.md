...
*   toml
    ...
    {  "type": "executiontime",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#8800dd",  "template": " <#fefefe></> {{ .FormattedMs }} ",  "properties": {    "threshold": 500,    "style": "austin",    "always_enabled": true  }}

    type: executiontimestyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#8800dd"template: " <#fefefe></> {{ .FormattedMs }} "properties:  threshold: 500  style: austin  always_enabled: true

    type = "executiontime"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#8800dd"template = " <#fefefe></> {{ .FormattedMs }} "[blocks.segments.properties]threshold = 500style = "austin"always_enabled = true
