...
*   toml
    ...
    {  "type": "sapling",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#193549",  "background": "#4C9642",  "background_templates": [    "{{ if .Bookmark }}#4C9642{{ end }}"  ],  "properties": {    "fetch_status": true  }}

    type: saplingstyle: powerlinepowerline_symbol: foreground: "#193549"background: "#4C9642"background_templates:  - "{{ if .Bookmark }}#4C9642{{ end }}"properties:  fetch_status: true

    type = "sapling"style = "powerline"powerline_symbol = ""foreground = "#193549"background = "#4C9642"background_templates = [ "{{ if .Bookmark }}#4C9642{{ end }}" ][blocks.segments.properties]fetch_status = true
