...
*   toml
    ...
    {  "type": "vlang",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#193549",  "background": "#4F87FF",  "template": "  {{ .Full }} "}

    type: vlangstyle: powerlinepowerline_symbol: foreground: "#193549"background: "#4F87FF"template: "  {{ .Full }} "
