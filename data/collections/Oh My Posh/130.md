...
*   toml
    ...
    {  "type": "wakatime",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#007acc",  "properties": {    "url": "https://wakatime.com/api/v1/users/current/summaries?start=today&end=today&api_key=API_KEY",    "http_timeout": 500  }}

    type: wakatimestyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#007acc"properties:  url: https://wakatime.com/api/v1/users/current/summaries?start=today&end=today&api_key=API_KEY  http_timeout: 500

    type = "wakatime"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#007acc"[blocks.segments.properties]url = "https://wakatime.com/api/v1/users/current/summaries?start=today&end=today&api_key=API_KEY"http_timeout = 500
...
*   toml
    ...
    {  "properties": {    "url": "https://wakatime.com/api/v1/users/current/summaries?start=today&end=today&api_key={{ .Env.WAKATIME_API_KEY }}",    "http_timeout": 500  }}

    properties:  url: https://wakatime.com/api/v1/users/current/summaries?start=today&end=today&api_key={{    .Env.WAKATIME_API_KEY }}  http_timeout: 500

    [blocks.segments.properties]url = "https://wakatime.com/api/v1/users/current/summaries?start=today&end=today&api_key={{ .Env.WAKATIME_API_KEY }}"http_timeout = 500
