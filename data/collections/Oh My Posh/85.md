...
*   toml
    ...
    {  "type": "withings",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#000000",  "template": "{{ if gt .Weight 0.0 }} {{ round .Weight 2 }}kg {{ end }}",  "properties": {    "access_token": "11111111111111111",    "refresh_token": "1111111111111111",    "http_timeout": 1500  }}

    type: withingsstyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#000000"template: "{{ if gt .Weight 0.0 }} {{ round .Weight 2 }}kg {{ end }}"properties:  access_token: "11111111111111111"  refresh_token: "1111111111111111"  http_timeout: 1500

    type = "withings"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#000000"template = "{{ if gt .Weight 0.0 }} {{ round .Weight 2 }}kg {{ end }}"[blocks.segments.properties]access_token = "11111111111111111"refresh_token = "1111111111111111"http_timeout = 1_500
