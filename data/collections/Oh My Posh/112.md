...
*   toml
    ...
    {  "type": "os",  "style": "plain",  "foreground": "#26C6DA",  "background": "#546E7A",  "template": " {{ if .WSL }}WSL at {{ end }}{{.Icon}}",  "properties": {    "macos": "mac"  }}

    type: osstyle: plainforeground: "#26C6DA"background: "#546E7A"template: " {{ if .WSL }}WSL at {{ end }}{{.Icon}}"properties:  macos: mac

    type = "os"style = "plain"foreground = "#26C6DA"background = "#546E7A"template = " {{ if .WSL }}WSL at {{ end }}{{.Icon}}"[blocks.segments.properties]macos = "mac"
