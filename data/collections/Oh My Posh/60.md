...
*   toml
    ...
    {  "type": "yarn",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#FFFFFF",  "background": "#2E2A65",  "template": " 󰄛 {{ .Full }} "}

    type: yarnstyle: powerlinepowerline_symbol: foreground: "#FFFFFF"background: "#2E2A65"template: " 󰄛 {{ .Full }} "
