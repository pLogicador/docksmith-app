...
*   toml
    ...
    {  "type": "brewfather",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#33158A",  "background_templates": [    "{{ if and (.Reading) (eq .Status \"Fermenting\") (gt .ReadingAge 4) }}#cc1515{{end}}"  ],  "properties": {    "user_id": "abcdefg123456",    "api_key": "qrstuvw78910",    "batch_id": "hijklmno098765"  }}

    type: brewfatherstyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#33158A"background_templates:  - '{{ if and (.Reading) (eq .Status "Fermenting") (gt .ReadingAge 4)    }}#cc1515{{end}}'properties:  user_id: abcdefg123456  api_key: qrstuvw78910  batch_id: hijklmno098765

    type = "brewfather"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#33158A"background_templates = [  "{{ if and (.Reading) (eq .Status \"Fermenting\") (gt .ReadingAge 4) }}#cc1515{{end}}"][blocks.segments.properties]user_id = "abcdefg123456"api_key = "qrstuvw78910"batch_id = "hijklmno098765"
