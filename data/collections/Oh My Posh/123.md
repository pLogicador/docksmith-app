...
*   toml
    ...
    {  "type": "status",  "style": "diamond",  "foreground": "#ffffff",  "background": "#00897b",  "background_templates": [    "{{ if .Error }}#e91e63{{ end }}"  ],  "trailing_diamond": "",  "template": "<#193549></>  ",  "properties": {    "always_enabled": true  }}

    type: statusstyle: diamondforeground: "#ffffff"background: "#00897b"background_templates:  - "{{ if .Error }}#e91e63{{ end }}"trailing_diamond: template: "<#193549></>  "properties:  always_enabled: true

    type = "status"style = "diamond"foreground = "#ffffff"background = "#00897b"background_templates = [ "{{ if .Error }}#e91e63{{ end }}" ]trailing_diamond = ""template = "<#193549></>  "[blocks.segments.properties]always_enabled = true
