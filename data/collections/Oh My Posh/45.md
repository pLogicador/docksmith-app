...
*   toml
    ...
    {  "type": "nix-shell",  "style": "powerline",  "foreground": "blue",  "background": "transparent",  "template": "(nix-{{ .Type }})"}

    type: nix-shellstyle: powerlineforeground: bluebackground: transparenttemplate: (nix-{{ .Type }})
