...
| `preferred_executable` | `string` | `lua` | the preferred executable to use when fetching the version<br><br>*   `lua`: the Lua executable (**default**)<br>*   `luajit`: the LuaJIT executable |
