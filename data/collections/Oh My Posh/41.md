...
*   toml
    ...
    {  "type": "mvn",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#FFFFFF",  "background": "#2E2A65",  "template": " Maven {{ .Full }} "}

    type: mvnstyle: powerlinepowerline_symbol: foreground: "#FFFFFF"background: "#2E2A65"template: " Maven {{ .Full }} "
