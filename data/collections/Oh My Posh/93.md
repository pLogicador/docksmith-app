...
Display the currently active python version and virtualenv. Supports conda, virtualenv and pyenv (if python points to pyenv shim).
...
*   toml
    ...
    {  "type": "python",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#100e23",  "background": "#906cff",  "template": "  {{ .Full }} "}

    type: pythonstyle: powerlinepowerline_symbol: foreground: "#100e23"background: "#906cff"template: "  {{ .Full }} "
