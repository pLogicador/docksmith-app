...
*   toml
    ...
    {  "type": "kotlin",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#906cff",  "template": " <b>K</b> {{ .Full }} "}

    type: kotlinstyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#906cff"template: " <b>K</b> {{ .Full }} "
